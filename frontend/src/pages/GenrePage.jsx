...
export default function GenrePage() {
    ...
    const currentContent = selectedType === "movie" ? allMovies : allTvShows;
    ...
    const displayedContent = currentContent.slice(startIndex, endIndex);
    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                {/* Header with Back Button and Type Toggle */}
